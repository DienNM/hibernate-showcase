...
import com.dee.hibernate.mapping.tblperhierarchy.CustomerModel;
import com.dee.hibernate.mapping.tblperhierarchy.EmployeeModel;
...
public class TablePerHierarchyTest extends TestCase{
    ...
    public void testCreateTables() {
        ...
        Assert.assertEquals("cus", pCustomer.getUserType());
        Assert.assertEquals("Retailer", pCustomer.getType());
        
        Assert.assertNotNull(pEmployee);
        Assert.assertEquals("emp", pEmployee.getUserType());
